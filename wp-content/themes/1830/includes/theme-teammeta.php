...
$meta_box_team = array(
	'id' => 'my-meta-box-team',
	'title' =>  __('Personal Options', 'theme1830'),
	'page' => 'team',
	'context' => 'normal',
	'priority' => 'high',
	'fields' => array(
    	array(
    	   'name' => __('Position', 'theme1830'),
    	   'desc' => __('Input position of the person.', 'theme1830'),
    	   'id' => $prefix . 'team_pos',
    	   'type' => 'text',
    	   'std' => ''
    	),
			array(
    	   'name' => __('Info', 'theme1830'),
    	   'desc' => __('Input additional info.', 'theme1830'),
    	   'id' => $prefix . 'team_info',
    	   'type' => 'text',
    	   'std' => ''
    	)
...
function my_add_box_team() {
	...
	add_meta_box($meta_box_team['id'], $meta_box_team['title'], 'my_show_box_team', $meta_box_team['page'], $meta_box_team['context'], $meta_box_team['priority']);
...
function my_show_box_team() {
	...
	echo '<p style="padding:10px 0 0 0;">'.__('Please fill additional fields for person. ', 'theme1830').'</p>';
