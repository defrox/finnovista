...
$meta_box_slider = array(
	...
	'title' =>  __('Slider Options', 'theme1830'),
	'page' => 'slider',
	'context' => 'normal',
	'priority' => 'high',
	'fields' => array(
    	array(
    	   'name' => __('Caption', 'theme1830'),
    	   'desc' => __('Input your caption for slide (HTML tags are allowed). ', 'theme1830'),
    	...
    	array(
    	   ...
    	   'desc' => __('Input the slide URL (can be external link)', 'theme1830'),
...
function my_add_box_slider() {
	...
	add_meta_box($meta_box_slider['id'], $meta_box_slider['title'], 'my_show_box_slider', $meta_box_slider['page'], $meta_box_slider['context'], $meta_box_slider['priority']);
...
function my_show_box_slider() {
	...
	echo '<p style="padding:10px 0 0 0;">'.__('Please fill additional fields for slide. ', 'theme1830').'</p>';
