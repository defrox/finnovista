...
<div class="wrap">
  ...
  if($xml = stag_get_theme_changelog()){
    if(version_compare(STAG_THEME_VERSION, $xml->latest) == -1){
      ...
      <img style="width:200px;float:left;margin:0 20px 20px 0;border:1px solid #ddd;" src="<?php echo get_template_directory_uri() .'/screenshot.png'; ?>" alt="<?php echo STAG_THEME_NAME; ?>" />
      ...
      if(STAG_THEME_TYPE == 'premium'){
        ...
        $message = 'To update the '.STAG_THEME_NAME.' theme, head over to dowloads section of '.STAG_MARKET.'.';
