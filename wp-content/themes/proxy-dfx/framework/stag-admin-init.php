...
function stag_admin_scripts(){
  ...
  wp_enqueue_script('stag-admin-js', STAG_URL .'/js/stag-admin.js', array('jquery', 'wp-color-picker'));
...
function stag_menu(){
  ...
  //   }
  // }
  // add_submenu_page('stagframework', __('Theme Updates', 'stag'), __($menu_title, 'stag'), 'update_core', 'stagframework-update', 'stag_update_page' );
