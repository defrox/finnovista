  ...
  <div id="stag-admin-wrap">
    <form action="<?php echo site_url() .'/wp-admin/admin-ajax.php'; ?>" method="post" id="stag-form">
      <div class="stag-header">
        ...
        <p>
          by <a href="//mauryaratan.me?ref=stagframework">Ram Ratan Maurya</a>
          &middot; <a href="<?php echo STAG_FEEDBACK_URL; ?>">Feedback</a>
        </p>
        <div id="stag-logo"><a href="//codestag.com?ref=stagframework" title="Send feedback to Codestag" target="_blank"></a></div>
      </div>
        ...
        <div class="stag-main-content">
          ...
          <div id="page-<?php echo stag_to_slug(key($page)); ?>" class="page">
            ...
            <?php foreach($page[key($page)] as $item) : ?>
              ...
              <div class="row <?php echo stag_to_slug(@$item['title']); ?> clearfix">
