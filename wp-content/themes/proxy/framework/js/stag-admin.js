...
j(document).ready(function($){
  ...
  // WP3.5 Colorpicker
  $('.colorpicker, #_stag_event_color, #_stag_event_font_color, #_stag_challenges_background_color, #_stag_challenges_font_color').each(function(){
    $(this).wpColorPicker();
  });
  ...
  if (jQuery().datepicker) {
      $("#_stag_portfolio_date").datepicker({
          "dateFormat": 'd M, yy',
      });
      $("#_stag_event_date").datepicker({
          "dateFormat": 'yy-mm-dd',
      });
      $("#_stag_event_agenda_date").datepicker({
          "dateFormat": 'yy-mm-dd',
      });
  }

  // if (jQuery().timepicker){
  //   $("#_stag_event_agenda_start").timepicker({
  //       timeFormat:'HH:mm'
  //   });
  //   $("#_stag_event_agenda_end").datetimepicker({
  //       timeFormat:'HH:mm'
  //   });
  //
  // }
