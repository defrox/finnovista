<?php
add_action('widgets_init', create_function('', 'return register_widget("stag_section_daily_agenda");'));

class stag_section_daily_agenda extends WP_Widget
{
    function stag_section_daily_agenda()
    {
        $widget_ops = array('classname' => 'section-block', 'description' => __('Displays the agenda for the event.', 'stag'));
        $control_ops = array('width' => 300, 'height' => 350, 'id_base' => 'stag_section_daily_agenda');
        $this->WP_Widget('stag_section_daily_agenda', __('Homepage: Daily Agenda', 'stag'), $widget_ops, $control_ops);
    }
...
//        }
        ...
        <!-- BEGIN #daily-agenda.section-block -->
        <section id="<?php echo stag_to_slug($id); ?>" class="section-block content-section daily-agenda">
            ...
            <!-- END #daily-agenda.section-block -->
        </section>
