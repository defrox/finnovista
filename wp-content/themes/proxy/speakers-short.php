<?php
/*
 * Template Name: Speakers Short Page
                        ...
                        <div class="member">
                            ...
                            <div class="member-description">
                                <p class="member-title"><a
                                            href="/listado-colaboradores/?<?php print ($category != '' ? '&cat=' . urlencode($category) : '') . ($area != '' ? '&area=' . urlencode($area) : '') . ($fscity != '' ? '&fscity=' . urlencode($fscity) : '') . ($pdcity != '' ? '&pdcity=' . urlencode($pdcity) : '') . ($visacity != '' ? '&visacity=' . urlencode($visacity) : '') . '#' . get_the_ID(); ?>"><?php the_title(); ?></a>
                                </p>
