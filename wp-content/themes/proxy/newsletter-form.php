...
<div id='crmWebToEntityForm'>
    ...
    <form action='https://crm.zoho.com/crm/WebToLeadForm' name=WebToLeads1481567000000841740 method='POST' onSubmit='javascript:document.charset="UTF-8"; return checkMandatoryFooter()' accept-charset='UTF-8'>
        ...
        <input type='text' style='display:none;' name='xmIwtLD' value='0d6379c70c887ee0371a71992e27b8d9bce724854d525dfc88aa62a8afad1193'/>
        <input type='text' style='display:none;' name='actionType' value='TGVhZHM='/>
        <input type='text' style='display:none;' name='returnURL' value='http&#x3a;&#x2f;&#x2f;www.finnovista.com&#x2f;thankyou&#x2f;'/>
            ...
            <tr style='display:none;'>
                ...
                <td>
                    <select name='Lead Source'>
                        ...
                        <option value='Employee&#x20;Referral'>Recomendaci&oacute;n de empleado</option>
                        <option value='External&#x20;Event'>External Event</option>
                        <option value='External&#x20;Referral'>Recomendaci&oacute;n externa</option>
                        <option value='LinkedIn'>LinkedIn</option>
                        <option value='Other'>Otro</option>
                        <option value='Partner'>Socio</option>
                        <option value='Twitter'>Twitter</option>
                        <option value='Webform&#x20;-&#x20;Brazil'>Webform - Brazil</option>
                        <option value='Webform&#x20;-&#x20;&#x20;Colombia'>Webform - Colombia</option>
                        <option value='Webform&#x20;-&#x20;Competition'>Webform - Competition</option>
                        <option value='Webform&#x20;-&#x20;General&#x20;Info'>Webform - General Info</option>
                        <option value='Webform&#x20;-&#x20;Mexico'>Webform - Mexico</option>
                        <option selected value='Webform&#x20;-&#x20;Newsletter'>Webform - Newsletter</option>
                    </select></td>
            </tr>
            <tr>
                <td style='width:25%; text-align: right;'><strong><?php _e('Subscribe now to our newsletter'); ?></strong></td>
                <td style='nowrap:nowrap;text-align:right;width:10%;'><?php _e('First Name'); ?><span style='color:red;'>*</span></td>
                <td style='width:15%;'><input type='text' style='width:100%;' maxlength='40' name='First Name'/></td>
                <td style='nowrap:nowrap;text-align:right;width:10%;'><?php _e('Email'); ?><span style='color:red;'>*</span></td>
                <td style='width:15%;'><input type='text' style='width:100%;' maxlength='100' name='Email'/></td>
            </tr>
            <tr>
                <td>&nbsp;</td>
                <td style='nowrap:nowrap;text-align:right;width:10%;'><?php _e('Last Name'); ?><span style='color:red;'>*</span></td>
                <td style='width:15%;'><input type='text' style='width:100%;' maxlength='80' name='Last Name'/></td>
                <td style='nowrap:nowrap;text-align:right;width:10%;'><?php _e('I am from ...'); ?><span style='color:red;'>*</span></td>
                <td style='width:15%;'>
                    <select style='width:100%;' name='LEADCF5'>
                        ...
                        <option value='Saint&#x20;Helena,&#x20;Ascension&#x20;and&#x20;Tristan&#x20;da&#x20;Cunha&#x20;&#x28;UK&#x29;'>Saint Helena, Ascension and Tristan da Cunha
                            &#x28;UK&#x29;</option>
        ...
        <script>
            var mndFileds34 = new Array('First Name', 'Last Name', 'Email', 'LEADCF5');
            var fldLangVal34 = new Array('<?php echo __('First Name'); ?>', '<?php echo __('Last Name'); ?>', '<?php echo __('Email'); ?>', '<?php echo __('I am from ...'); ?>');
            var name = '';
            var email = '';

            function checkMandatoryFooter() {
                if (document.forms['WebToLeads1481567000000841740']['dfx_gotcha'] && document.forms['WebToLeads1481567000000841740']['dfx_gotcha'].value != '') {
                    return false;
                }
                for (i = 0; i < mndFileds34.length; i++) {
                    var fieldObj = document.forms['WebToLeads1481567000000841740'][mndFileds34[i]];
                    if (fieldObj) {
                        if (((fieldObj.value).replace(/^\s+|\s+$/g, '')).length == 0) {
                            if (fieldObj.type == 'file') {
                                alert('<?php echo __('Please select a file to upload'); ?>'); //Seleccione un archivo para cargar
                                fieldObj.focus();
                                return false;
                            }
                            alert(fldLangVal34[i] + ' <?php echo __('cannot be empty'); ?>'); //no puede estar vacío
                            fieldObj.focus();
                            return false;
                        } else if (fieldObj.nodeName == 'SELECT') {
                            if (fieldObj.options[fieldObj.selectedIndex].value == '-None-') {
                                alert(fldLangVal34[i] + ' <?php echo __('cannot be none'); ?>'); //no puede ser nulo
                                fieldObj.focus();
                                return false;
                            }
                        } else if (fieldObj.type == 'checkbox') {
                            if (fieldObj.checked == false) {
                                alert('<?php echo __('Please accept'); ?>  ' + fldLangVal34[i]); //Por favor acepte
                                fieldObj.focus();
                                return false;
                            }
                        }
