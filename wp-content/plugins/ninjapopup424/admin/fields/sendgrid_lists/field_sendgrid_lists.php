...
class SNP_NHP_Options_sendgrid_lists extends SNP_NHP_Options
{
...
//function
	...
	function render()
	{
		...
		$this->field['options']=snp_ml_get_sendgrid_lists();
		...
		{
		    echo '<input type="button" rel-id="' . $this->field['id'] . '" class="button sendgrid_lists_gl" name="" value="Grab Lists" />';
		}
...
//function
	...
	function enqueue()
	{
		...
		wp_enqueue_script(
				'nhp-opts-field-sendgrid_lists-js', SNP_NHP_OPTIONS_URL . 'fields/sendgrid_lists/field_sendgrid_lists.js', array('jquery', 'farbtastic'), time(), true
		);
	}
