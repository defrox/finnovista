...
class SNP_NHP_Options_elasticemail_lists extends SNP_NHP_Options
{
...
//function
	...
	function render()
	{
		...
		$this->field['options']=snp_ml_get_elasticemail_lists();
		...
		{
		    echo '<input type="button" rel-id="' . $this->field['id'] . '" class="button elasticemail_lists_gl" name="" value="Grab Lists" />';
		}
...
//function
	...
	function enqueue()
	{
		...
		wp_enqueue_script(
				'nhp-opts-field-elasticemail_lists-js', SNP_NHP_OPTIONS_URL . 'fields/elasticemail_lists/field_elasticemail_lists.js', array('jquery', 'farbtastic'), time(), true
		);
	}
