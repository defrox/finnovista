...
class SNP_NHP_Options_freshmail_lists extends SNP_NHP_Options
{
...
//function
	...
	function render()
	{
		...
		$this->field['options']=snp_ml_get_freshmail_lists();
		...
		{
		    echo '<input type="button" rel-id="' . $this->field['id'] . '" class="button freshmail_lists_gl" name="" value="Grab Lists" />';
		}
...
//function
	...
	function enqueue()
	{
		...
		wp_enqueue_script(
				'nhp-opts-field-freshmail_lists-js', SNP_NHP_OPTIONS_URL . 'fields/freshmail_lists/field_freshmail_lists.js', array('jquery', 'farbtastic'), time(), true
		);
	}
