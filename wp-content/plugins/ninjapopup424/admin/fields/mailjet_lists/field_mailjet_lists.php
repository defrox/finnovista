...
class SNP_NHP_Options_mailjet_lists extends SNP_NHP_Options
{
...
//function
	...
	function render()
	{
		...
		$this->field['options']=snp_ml_get_mailjet_lists();
		...
		{
		    echo '<input type="button" rel-id="' . $this->field['id'] . '" class="button mailjet_lists_gl" name="" value="Grab Lists" />';
		}
...
//function
	...
	function enqueue()
	{
		...
		wp_enqueue_script(
				'nhp-opts-field-mailjet_lists-js', SNP_NHP_OPTIONS_URL . 'fields/mailjet_lists/field_mailjet_lists.js', array('jquery', 'farbtastic'), time(), true
		);
	}
