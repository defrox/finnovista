...
class SNP_NHP_Options_sendinblue_lists extends SNP_NHP_Options
{
...
//function
	...
	function render()
	{
		...
		$this->field['options']=snp_ml_get_sendinblue_lists();
		...
		{
		    echo '<input type="button" rel-id="' . $this->field['id'] . '" class="button sendinblue_lists_gl" name="" value="Grab Lists" />';
		}
...
//function
	...
	function enqueue()
	{
		...
		wp_enqueue_script(
				'nhp-opts-field-sendinblue_lists-js', SNP_NHP_OPTIONS_URL . 'fields/sendinblue_lists/field_sendinblue_lists.js', array('jquery', 'farbtastic'), time(), true
		);
	}
