...
class SNP_NHP_Options_rocketresponder_lists extends SNP_NHP_Options
{
...
//function
	...
	function render()
	{
		...
		$this->field['options']=snp_ml_get_rocketresponder_lists();
		...
		{
		    echo '<input type="button" rel-id="' . $this->field['id'] . '" class="button rocketresponder_lists_gl" name="" value="Grab Lists" />';
		}
...
//function
	...
	function enqueue()
	{
		...
		wp_enqueue_script(
				'nhp-opts-field-rocketresponder_lists-js', SNP_NHP_OPTIONS_URL . 'fields/rocketresponder_lists/field_rocketresponder_lists.js', array('jquery', 'farbtastic'), time(), true
		);
	}
