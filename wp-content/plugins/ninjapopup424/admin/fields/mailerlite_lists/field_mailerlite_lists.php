...
class SNP_NHP_Options_mailerlite_lists extends SNP_NHP_Options
{
...
//function
	...
	function render()
	{
		...
		$this->field['options']=snp_ml_get_mailerlite_lists();
		...
		{
		    echo '<input type="button" rel-id="' . $this->field['id'] . '" class="button mailerlite_lists_gl" name="" value="Grab Lists" />';
		}
...
//function
	...
	function enqueue()
	{
		...
		wp_enqueue_script(
				'nhp-opts-field-mailerlite_lists-js', SNP_NHP_OPTIONS_URL . 'fields/mailerlite_lists/field_mailerlite_lists.js', array('jquery', 'farbtastic'), time(), true
		);
	}
