...
class SNP_NHP_Options_benchmarkemail_lists extends SNP_NHP_Options
{
...
//function
	...
	function render()
	{
		...
		$this->field['options']=snp_ml_get_benchmarkemail_lists();
		...
		{
		    echo '<input type="button" rel-id="' . $this->field['id'] . '" class="button benchmarkemail_lists_gl" name="" value="Grab Lists" />';
		}
...
//function
	...
	function enqueue()
	{
		...
		wp_enqueue_script(
				'nhp-opts-field-benchmarkemail_lists-js', SNP_NHP_OPTIONS_URL . 'fields/benchmarkemail_lists/field_benchmarkemail_lists.js', array('jquery', 'farbtastic'), time(), true
		);
	}
