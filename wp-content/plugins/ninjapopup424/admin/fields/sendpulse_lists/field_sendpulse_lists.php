...
class SNP_NHP_Options_sendpulse_lists extends SNP_NHP_Options
{
...
//function
	...
	function render()
	{
		...
		$this->field['options']=snp_ml_get_sendpulse_lists();
		...
		{
		    echo '<input type="button" rel-id="' . $this->field['id'] . '" class="button sendpulse_lists_gl" name="" value="Grab Lists" />';
		}
...
//function
	...
	function enqueue()
	{
		...
		wp_enqueue_script(
				'nhp-opts-field-sendpulse_lists-js', SNP_NHP_OPTIONS_URL . 'fields/sendpulse_lists/field_sendpulse_lists.js', array('jquery', 'farbtastic'), time(), true
		);
	}
