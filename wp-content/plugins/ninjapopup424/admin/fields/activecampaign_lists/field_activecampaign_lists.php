...
class SNP_NHP_Options_activecampaign_lists extends SNP_NHP_Options
{
...
//function
	...
	function render()
	{
		...
		$this->field['options']=snp_ml_get_activecampaign_lists();
		...
		{
		    echo '<input type="button" rel-id="' . $this->field['id'] . '" class="button activecampaign_lists_gl" name="" value="Grab Lists" />';
		}
...
//function
	...
	function enqueue()
	{
		...
		wp_enqueue_script(
				'nhp-opts-field-activecampaign_lists-js', SNP_NHP_OPTIONS_URL . 'fields/activecampaign_lists/field_activecampaign_lists.js', array('jquery', 'farbtastic'), time(), true
		);
	}
