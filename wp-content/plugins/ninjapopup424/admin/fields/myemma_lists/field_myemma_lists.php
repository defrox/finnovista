...
class SNP_NHP_Options_myemma_lists extends SNP_NHP_Options
{
...
//function
	...
	function render()
	{
		...
		$this->field['options']=snp_ml_get_myemma_lists();
		...
		{
		    echo '<input type="button" rel-id="' . $this->field['id'] . '" class="button myemma_lists_gl" name="" value="Grab Lists" />';
		}
...
//function
	...
	function enqueue()
	{
		...
		wp_enqueue_script(
				'nhp-opts-field-myemma_lists-js', SNP_NHP_OPTIONS_URL . 'fields/myemma_lists/field_myemma_lists.js', array('jquery', 'farbtastic'), time(), true
		);
	}
