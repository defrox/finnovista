...
if(isset($_GET['import_elements']))
{
    ...
    elseif($elements['response']['code']==403)
    {
...
<div class="snp-library-cont">
    ...
    <div id="snp-library-elements">
        ...
        if($snp_library_ver_local!==false && version_compare($snp_library_ver_local, $snp_library_ver_remote,'=='))
        {
