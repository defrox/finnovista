! function(e) {
    var t = function(t) {
        ...
        t = t || {}, "string" == typeof t && (t = {
        	...
        	this.textSelection = "", 
        	this.htmlSelection = "", 
        	this.appId = e('meta[property="fb:app_id"]').attr("content") || e('meta[property="fb:app_id"]').attr("value"), 
        	this.viaTwitterAccount = e('meta[name="twitter:site"]').attr("content") || e('meta[name="twitter:site"]').attr("value"), 
        	this.url2share = e('meta[property="og:url"]').attr("content") || e('meta[property="og:url"]').attr("value") || window.location.href, 
        this.getSelectionText = function(e) {
            var t = "",
                o = "",
            ...
            var t = "“" + n.smart_truncate(n.textSelection.trim(), 114) + "”",
                o = "http://twitter.com/intent/tweet?text=" + encodeURIComponent(t) + "&related=" + n.getRelatedTwitterAccounts() + "&url=" + encodeURIComponent(window.location.href);
            	n.viaTwitterAccount && t.length < 114 - n.viaTwitterAccount.length && (o += "&via=" + n.viaTwitterAccount.replace('@',''));
            var i = 640,
                r = 440,
            ...
            return window.open(o, "share_twitter", "toolbar=no, location=no, directories=no, status=no, menubar=no, scrollbars=no, resizable=no, copyhistory=no, width=" + i + ", height=" + r + ", top=" + l + ", left=" + a), n.hide(), !1
		      ...
		      e.preventDefault();
		      var text = n.htmlSelection.replace(/<p[^>]*>/ig,'\n').replace(/<\/p>|  /ig,'').trim();

		      var url = 'https://www.facebook.com/dialog/feed?' +
		                'app_id='+n.appId +
		                '&display=popup'+
		                '&caption='+encodeURIComponent(text)+
		                '&link='+encodeURIComponent(n.url2share)+
		                '&href='+encodeURIComponent(n.url2share)+
		                '&redirect_uri='+encodeURIComponent(n.url2share);
		      var w = 640, h=440;
            ...
            var t = n.htmlSelection.replace(/<p[^>]*>/gi, "\n").replace(/<\/p>|  /gi, "").trim(),
                o = "https://www.linkedin.com/shareArticle?mini=true&url=" + encodeURIComponent(n.url2share) + "&title=" + encodeURIComponent(n.textSelection.trim()),
                i = 640,
                r = 440,
                a = screen.width / 2 - i / 2,
                l = screen.height / 2 - r / 2 - 100;
