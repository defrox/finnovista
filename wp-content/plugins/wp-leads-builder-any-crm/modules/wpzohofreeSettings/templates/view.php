	...
	<div class="wp-common-crm-content" style="width: 100%;float: left;">
		...
		<table class="settings-table">
			...
			<tr>
				...
				<td>
					<input type='text' class='smack-zoho-settings-text' name='username' id='smack_host_username' value="<?php echo sanitize_text_field($config['username']) ?>"/>
				</td>
			</tr>
			<tr>
				<td style='width:160px;padding-left:40px;'>
				...
				<td>
					<input type='password' class='smack-zoho-settings-text' name='password' id='smack_host_access_key' value="<?php echo sanitize_text_field($config['password']) ?>"/>
				</td>
			</tr>
