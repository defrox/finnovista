...
?>
	<br>
<div class="tooltipp" style="float:left;marginThirdparty1px;margin-left:25%;">
			<input type="button" size="50" class="button-primary" value="Create Lead Form" disabled="disabled"><span class="tooltiptext"><a href ="https://www.smackcoders.com/wp-leads-builder-any-crm-pro.html" target="_blank"><h4> Upgrade To Pro </h4></a></span></div>

<div class="tooltipp" style="float:left;margin-top:-1px;margin-left:50px;">
                        <input type="button" size="50" class="button-primary" value="Create Contact Form" disabled="disabled"><span class="tooltiptext"><a href ="https://www.smackcoders.com/wp-leads-builder-any-crm-pro.html" target="_blank"><h4> Upgrade To Pro</h4> </a></span></div>
<div class="tooltipp" style="float:left;margin-top:-1px;margin-left:65px;">
                        <input type="button" size="50" class="button-primary" value="Use Existing Forms" disabled="disabled"><span class="tooltiptext"><a href ="https://www.smackcoders.com/wp-leads-builder-any-crm-pro.html" target="_blank"><h4> Upgrade To Pro </h4></a></span></div>
<!--	<table>
	<tr>
	<td><div style="float:left;margin-left:33%;">
		 <input type = "button" size = "50" class = "button-primary" value ="Create Lead Form" id ="advance_option" onclick="jQuery('#mandatory-upgrade').show(); jQuery('#mandatory-upgrade').css('display','inline')"> <span id="mandatory-upgrade" style="color:red; display:none;"> <a href ="https://www.smackcoders.com/wp-leads-builder-any-crm-pro.html" target="_blank"> Upgrade To Pro </a> </span>
    </div>   </td>
	<td>
	<div style="float:left;margin-left:50px;">	
	 <input type = "button" size = "50"  class = "button-primary" value ="Create Contact Form" id ="advance_option" onclick="jQuery('#mandatory-upgrad').show(); jQuery('#mandatory-upgrad').css('display','inline')"> <span id="mandatory-upgrad" style="color:red; display:none;"> <a href ="https://www.smackcoders.com/wp-leads-builder-any-crm-pro.html" target="_blank"> Upgrade To Pro </a> </span>
</div>	 </td>
	<td>
		<div style="float:left;margin-left:50px;">
		 <input type = "button" size = "50" class = "button-primary" value ="Use Existing Form" id ="advance_option" onclick="jQuery('#mandatory-upgra').show(); jQuery('#mandatory-upgra').css('display','inline')"> <span id="mandatory-upgra" style="color:red; display:none;"> <a href ="https://www.smackcoders.com/wp-leads-builder-any-crm-pro.html" target="_blank"> Upgrade To Pro </a> </span>
       </div>  </td>
